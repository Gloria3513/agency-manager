...
- **📥 스프레드시트 일괄 등록**: CSV/엑셀 파일로 고객 일괄 등록
...
### ✅ 2단계 (완료)
- **🤖 AI 견적서 자동 생성**: Gemini API 연동, 문의 내용 분석 후 자동 견적 생성
- **📄 PDF 다운로드**: 한글 폰트 지원, 전문적인 견적서 PDF 생성
  - **버그 수정 (2026-02-07)**: Streamlit button 내부 download_button 문제 해결
  - **버그 수정 (2026-02-07)**: font_registered 초기화 오류 수정
  - **버그 수정 (2026-02-07)**: Korean-Bold 폰트 오류 수정
- **📋 견적서 미리보기**: 생성 후 바로 상세 내용 확인 (2026-02-07 추가)
- **📧 이메일 발송**: SMTP 연동, HTML 템플릿, PDF 첨부
  - **기능 추가 (2026-02-07)**: 미리보기에서 바로 이메일 발송
